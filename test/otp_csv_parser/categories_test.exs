defmodule OtpCsvParser.CategoriesTest do
  use OtpCsvParser.DataCase

  alias OtpCsvParser.Categories

  describe "categories" do
    alias OtpCsvParser.Categories.Category

    @valid_attrs %{name_ar: "some name_ar", name_en: "some name_en"}
    @update_attrs %{name_ar: "some updated name_ar", name_en: "some updated name_en"}
    @invalid_attrs %{name_ar: nil, name_en: nil}
    ...
    test "create_category/1 with valid data creates a category" do
      ...
      assert category.name_ar == "some name_ar"
    ...
    test "update_category/2 with valid data updates the category" do
      ...
      assert category.name_ar == "some updated name_ar"
