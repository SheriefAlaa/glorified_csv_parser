defmodule OtpCsvParser.ProductsTest do
  ...
  describe "products" do
    ...
    test "create_product/1 with valid data creates a product" do
      ...
      assert product.description_ar == "some description_ar"
      assert product.description_en == "some description_en"
      assert product.listed == true
    ...
    test "update_product/2 with valid data updates the product" do
      ...
      assert product.description_ar == "some updated description_ar"
      assert product.description_en == "some updated description_en"
      assert product.listed == false
